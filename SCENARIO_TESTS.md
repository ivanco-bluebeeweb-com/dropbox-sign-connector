# Plausible Scenario Tests (PST) — Dropbox Sign Connector
...
- `connect_dropbox_sign`: validated contract & error handling
- `list_connections`: validated contract & error handling
- `disconnect_dropbox_sign`: validated contract & error handling
